...
public abstract class StackReaderUnary extends StackReader {
     ...
     * @throws ImageIOException if the image cannot be opened.
     */
    protected abstract OpenedImageFile wrapOpenedFile(
            Path path, OpenedImageFile openedFileFromDelegate) throws ImageIOException;
}

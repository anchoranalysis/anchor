...
public enum StackRGBState {
     ...
     * @param withAlpha true if alpha is present, false if it is not. Ignored when {@code rgb==false}.
     ...
     * 
     * <p>The ordering is increasingly: {@code NOT_RGB}, {@code RGB_WITHOUT_ALPHA}, {@code RGB_WITH_ALPHA}.
     * 

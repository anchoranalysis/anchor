...
/**
 * A base-class for a raster-writer that writes only one or three channeled images, and a flexible extension.
 * 
 * @author Owen Feehan
 *
 */
public abstract class OneOrThreeChannelsWriter extends RasterWriter {
    ...
    protected abstract void writeStackAfterCheck(Stack stack, Path filePath) throws RasterIOException;
}

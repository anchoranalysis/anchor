...
public class VoxelsArithmeticFactory {
     ...
     * @param bufferForSlice a buffer for a particular slice index (set at the initial position in the buffer)
     * @return
     */
    public static VoxelsArithmetic createByte(Extent extent, IntFunction<ByteBuffer> bufferForSlice) {
     ...
     * @return
     */
    public static VoxelsArithmetic createShort(Extent extent, IntFunction<ShortBuffer> bufferForSlice) {

 ...
 * 
 * <p>This usually either the class themselves or a type that is minimally
 * larger, and can represent both types without loss of precision.
 * 
 * <p>An exception is the float-type that takes precedence over all others,
 * and this may lead to loss of precision.
 * 
 * @author Owen Feehan
 *
 */
...
public class FindCommonVoxelType {
     ...
     * @return a type that can represent all types (think of it as a minimal superset of all types), or {@link Optional#empty} if the stream has no elements.
     */
    ...
    /**
     * Finds a common type to represent (ideally without loss of precision} both {@code first} and {@code second}.
     *  

...
/**
 * Utilities for iterating over the subset of voxels corresponding to an <i>on</i> state in a {@link Mask}.
 * 
...
public class IterateVoxelsMask {
    ...
    public static <T> void withBuffer(
            Mask mask, Voxels<T> voxels, ProcessBufferUnary<T> process) {
    ...
    /**
     * Calculates the sum and count across voxels intensity that correspond to <i>on</i> voxels on a <i>mask</i>
     *

...
public class BinaryVoxelBoxFactory {
    ...
    public BinaryVoxelBox<ByteBuffer> create(Extent extent) throws CreateException {
        return (BinaryVoxelBox<ByteBuffer>)
                create(extent, VoxelDataTypeUnsignedByte.INSTANCE, BinaryValues.getDefault());
    }
     ...
     * @throws CreateException
     */
    public BinaryVoxelBox<?> create(
            Extent extent, VoxelDataType dataType, BinaryValues binaryValues)
            throws CreateException {

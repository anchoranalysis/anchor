...
public class NeighborGraphTest {
    ...
    private void testBoth2DAnd3D( int expectedNumberEdges, boolean preventObjectIntersection, ObjectCollectionFixture fixture) throws CreateException {
        String prefix = preventObjectIntersection ? "preventObjectIntersection" : "allowObjectIntersection";
    ...
    private void test(String prefix, int expectedNumberEdges, boolean preventObjectIntersection, boolean do3D, ObjectCollectionFixture fixture) throws CreateException {
        
        fixture.setDo3D(do3D);
        ObjectCollection objects = fixture.createObjects(false);
        GraphWithPayload<ObjectMask,Integer> graph = NeighborGraph.create(objects, fixture.extentLargerThanAllObjects(), preventObjectIntersection, do3D);

...
/**
 * Base class for an {@link OutputEnabledRules} that specifies particular output-names for first and second levels.
 * 
 * @author Owen Feehan
 *
 */
...
public abstract class OutputEnableRulesSpecify extends OutputEnabledRules {
    ...
    private List<NamedBean<StringSet>> second = new ArrayList<>();
    // END BEAN PROPERTIES

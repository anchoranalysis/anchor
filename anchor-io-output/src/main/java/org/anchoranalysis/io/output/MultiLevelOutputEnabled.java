 ...
 * <li>a second-level, given a particular output-name from the first-level, enabling particular sub-output-names or not.
 * </ul>
 * 
 * <p>e.g. the first-level might enable a collection of images in general or not, and the second-level might enable particular names of particular images or not.
 * 
 * @author Owen Feehan
 *
 */
public interface MultiLevelOutputEnabled {
    ...
    /**
     * A second-level of {@link OutputEnabled} for a particular {@code outputName} as used in first-level.
     */

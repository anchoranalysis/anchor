...
public class OutputEnabledDelta {
    ...
    /**
     * Output-names that are enabled, before additionally applying whichever other rules are employed.
     * 
     ...
     * 
     * <p>Note that this can be specific outputs, or it can be rules that permit
     * everything.
     * 

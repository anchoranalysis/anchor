 ...
 * 
 * <p>It is accompanied by a {@link LazyDirectoryCreatorPool} that an error/deletion occurs
 * before any outputs are written to a directory that already exists.
 * @author Owen Feehan
 *
 */
@AllArgsConstructor
class BoundDirectory {
     ...
     */
    public BoundDirectory(Path directoryPath, boolean deleteExistingDirectory) throws BindFailedException {
     ...
     *  
     * @param subDirectoryPath sub-directory of existing {@link BoundDirectory} for which a new {@link BoundDirectory} will be created.
    ...
    public BoundDirectory bindToSubdirectory(Path subDirectoryPath) throws BindFailedException {
        ...
        return new BoundDirectory(directoryCreator, creatorForDirectory(subDirectoryPath, parentDirectoryCreator) );
    }

...
class ScaleElementsInRow {
    ...
    public static void scaleElementsToMatchRow(
        ...
        // To fix the gap, one pixel width is added/subtracted (as circumstances need) from a certain
        // number of images, chosen by priority of the size of their rounding error, during prior scaling.
     ...
     * largest rounding-up errors to make smaller, and with the largest rounding-down errors to
     * make larger.
     *
